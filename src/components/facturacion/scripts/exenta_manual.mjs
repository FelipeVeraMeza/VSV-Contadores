...
export async function emitirExentaPuppeteer(datos, credSii = credencialesDelSistema()) {
    ...
    try {
        ...
        console.log('>>> Iniciando Robot de Facturación Exenta...');

        // =======================================================================
        // 2. LOGIN EN EL SII Y SELECCIÓN DE EMPRESA
        // =======================================================================
        ...
        // =======================================================================
        // 3. INGRESAR RUT DEL CLIENTE Y LANZAR AJAX
        // =======================================================================
        console.log(`📝 Escribiendo RUT del cliente (Exenta): ${datos.rutReceptor}-${datos.dvReceptor}`);
        await navegarAEmisionExenta(page); 
        ...
        // =======================================================================
        // 4. LLENAR DATOS SECUNDARIOS MIENTRAS SII PIENSA
        // =======================================================================
        ...
        // =======================================================================
        // 6. PRODUCTOS, FIRMA Y FOLIO
        // =======================================================================
        console.log('🛍️ Ingresando detalles del producto exento...');
        await page.type('input[name="EFXP_NMB_01"]', datos.producto.nombre || 'Servicio Exento', { delay: 50 });
        ...
        console.log('✅ Validando montos Exentos...');
        ...
        return { ok: true, folio: folio, tipo: 'Exenta', fileName: `Factura_Exenta_${folio}.pdf` };
