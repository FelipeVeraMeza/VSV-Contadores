            ...
            <DialogContent className="sm:max-w-[425px] bg-black/50 backdrop-blur-xl border-white/20 text-white">
                ...
                <div className="grid gap-4 py-4">
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-400 pt-1">Ingrese el RUT de la persona o empresa autorizada para operar el banco.</p>
                    </div>
                    <div className="space-y-2">
                ...
                <DialogFooter>
                    ...
                    <Button onClick={handleLogin} disabled={isConnecting} className="bg-gradient-to-r from-blue-500 to-purple-600 text-white border-none hover:opacity-90">
